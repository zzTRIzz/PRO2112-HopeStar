      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <h1 className="text-2xl font-bold">Giỏ hàng của bạn ({cartItems.length})</h1>
            {cartItems.length > 0 && (
              <Checkbox
                isSelected={cartItems.length > 0 && selectedItems.size === cartItems.length}
          ...
          <div className="lg:col-span-2">
            {isLoading ? (
              ...
              <div className="flex h-[400px] flex-col items-center justify-center gap-4 rounded-lg border-2 border-dashed border-default-200">
                <Icon icon="lucide:shopping-cart" className="h-12 w-12 text-default-300" />
