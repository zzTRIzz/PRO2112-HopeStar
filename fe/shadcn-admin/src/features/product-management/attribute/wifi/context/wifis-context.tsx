...
interface TasksContextType {
  ...
  currentRow: Wifi | null
  setCurrentRow: React.Dispatch<React.SetStateAction<Wifi | null>>
}
...
export default function TasksProvider({ children }: Props) {
  ...
  const [currentRow, setCurrentRow] = useState<Wifi | null>(null)
  return (
