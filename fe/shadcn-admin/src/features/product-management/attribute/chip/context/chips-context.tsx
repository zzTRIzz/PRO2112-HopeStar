...
interface TasksContextType {
  ...
  currentRow: Chip | null
  setCurrentRow: React.Dispatch<React.SetStateAction<Chip | null>>
}
...
export default function TasksProvider({ children }: Props) {
  ...
  const [currentRow, setCurrentRow] = useState<Chip | null>(null)
  return (
