...
import { TasksDialogs } from './components/chip-dialogs'
import { TasksPrimaryButtons } from './components/chip-primary-buttons'
import { DataTable } from './components/data-table'
import { StatusSwitch } from './components/status-switch'
import TasksProvider from './context/chips-context'
import type { Chip } from './data/schema'

const columns: ColumnDef<Chip>[] = [
  {
    accessorKey: 'id',
    header: 'STT',
    cell: ({ row }) => {
