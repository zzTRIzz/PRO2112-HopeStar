...
import { Resolution } from '../data/schema'
...
interface TasksContextType {
  ...
  currentRow: Resolution | null
  setCurrentRow: React.Dispatch<React.SetStateAction<Resolution | null>>
}
...
export default function TasksProvider({ children }: Props) {
  ...
  const [currentRow, setCurrentRow] = useState<Resolution | null>(null)
  return (
