...
import { RearCamera } from '../data/schema'
...
interface TasksContextType {
  ...
  currentRow: RearCamera | null
  setCurrentRow: React.Dispatch<React.SetStateAction<RearCamera | null>>
}
...
export default function TasksProvider({ children }: Props) {
  ...
  const [currentRow, setCurrentRow] = useState<RearCamera | null>(null)
  return (
