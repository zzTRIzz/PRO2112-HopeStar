...
import { Bluetooth } from '../data/schema'
...
interface TasksContextType {
  ...
  currentRow: Bluetooth | null
  setCurrentRow: React.Dispatch<React.SetStateAction<Bluetooth | null>>
}
...
export default function TasksProvider({ children }: Props) {
  ...
  const [currentRow, setCurrentRow] = useState<Bluetooth | null>(null)
  return (
