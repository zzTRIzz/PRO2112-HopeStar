...
import { TasksDialogs } from './components/bluetooth-dialogs'
import { TasksPrimaryButtons } from './components/bluetooth-primary-buttons'
import { DataTable } from './components/data-table'
import { StatusSwitch } from './components/status-switch'
import TasksProvider from './context/bluetooths-context'
import type { Bluetooth } from './data/schema'

const columns: ColumnDef<Bluetooth>[] = [
  {
    accessorKey: 'id',
    header: 'STT',
    cell: ({ row }) => {
