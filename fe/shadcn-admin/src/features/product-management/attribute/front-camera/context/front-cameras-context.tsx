...
import { FrontCamera } from '../data/schema'
...
interface TasksContextType {
  ...
  currentRow: FrontCamera | null
  setCurrentRow: React.Dispatch<React.SetStateAction<FrontCamera | null>>
}
...
export default function TasksProvider({ children }: Props) {
  ...
  const [currentRow, setCurrentRow] = useState<FrontCamera | null>(null)
  return (
