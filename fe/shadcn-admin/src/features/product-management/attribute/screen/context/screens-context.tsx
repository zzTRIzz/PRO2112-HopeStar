...
import { Screen } from '../data/schema'
...
interface TasksContextType {
  ...
  currentRow: Screen | null
  setCurrentRow: React.Dispatch<React.SetStateAction<Screen | null>>
}
...
export default function TasksProvider({ children }: Props) {
  ...
  const [currentRow, setCurrentRow] = useState<Screen | null>(null)
  return (
