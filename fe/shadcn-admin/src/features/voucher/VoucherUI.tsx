...
export default function VoucherUI() {
  ...
  const checkCode = async (code: string): Promise<boolean> => {
    ...
    try {
      ...
      const response = await axios.get(
        `${API_BASE_URL}/admin/voucher/check-code`,
        {
          params: {
            code: code.trim(),
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(
        error.response?.data?.message || 'Có lỗi xảy ra khi lưu voucher'
      )
    }
  }
      ...
      <div className='min-h-screen bg-gray-100 p-6'>
        ...
        <div className='mb-6'>
          <div className='rounded-lg bg-white p-4 shadow-md'>
            <h3 className='mb-4 text-lg font-medium'>Tìm kiếm voucher</h3>
        ...
        {vouchers.length > 0 && (
          <>
            ...
            <div className='mt-2 text-center text-sm text-gray-600'>
              ...
              {Math.min(indexOfLastItem, vouchers.length)}
          ...
          <div className='w-[500px] rounded-lg bg-white p-6'>
            ...
            <form onSubmit={handleSubmit}>
              <div className='space-y-4'>
                <div>
                  <label className='mb-1 block'>Mã voucher</label>
                  <input
                    type='text'
                ...
                <div>
                  <label className='mb-1 block'>Tên voucher</label>
                  <input
                    type='text'
                    className='w-full rounded border p-2'
                    value={formData.name}
                ...
                <div>
                  <label className='mb-1 block'>Giá trị</label>
                ...
                <div className='grid grid-cols-2 gap-4'>
                  <div>
                    ...
                    <input
                      ...
                      className='w-full rounded border p-2'
                      value={
                        formData.conditionPriceMin === 0
                          ? ''
                          : formData.conditionPriceMin
                      }
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          conditionPriceMin: e.target.value
                            ? Math.max(0, Number(e.target.value))
                            : 0,
                        })
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className='w-full rounded border p-2'
                      value={
                        formData.conditionPriceMax === 0
                          ? ''
                          : formData.conditionPriceMax
                      }
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          conditionPriceMax: e.target.value
                            ? Math.max(0, Number(e.target.value))
                            : 0,
                        })
                      }
                ...
                <div>
                  <label className='mb-1 block'>Số lượng</label>
                  <input
                    type='number'
                    className='w-full rounded border p-2'
...
const AssignVoucherModal = ({
  ...
  const handleAssign = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${API_BASE_URL}/admin/voucher/assign`,
        {
  ...
  return (
    <div className='fixed inset-0 flex items-center justify-center bg-black bg-opacity-50'>
      <div className='max-h-[80vh] w-[800px] overflow-y-auto rounded-lg bg-white p-6'>
        ...
        <div className='mb-6 rounded-lg bg-blue-50 p-4'>
          <h3 className='mb-2 font-medium text-blue-800'>Chi tiết voucher</h3>
