  ...
  return (
    <>
      ...
      <div className="p-2 bg-white rounded-lg shadow-md border border-gray-300 mr-1.5" style={{ paddingTop: '18px', margin: '0 13px' }}>
        ...
        <HoaDonCho listBill={listBill} billChoThanhToan={billChoThanhToan} huyHoaDonTheoId={huyHoaDonTheoId} getById={getById} handleAddBill={handleAddBill}  idBill={idBill}/>
            ...
            <div className="flex space-x-2">
              ...
              <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                <DialogTrigger asChild>
                  <Button variant="outline" className="bg-blue-600 text-white hover:bg-gray-300 hover:text-blue-600" onClick={() => setDialogContent('product')}>
                    Thêm sản phẩm
                  </Button>
                </DialogTrigger>
                <DialogContent className="sm:max-w-[980px]">
                  ...
                  {dialogContent === 'product' ? (
                        ...
                        <TableBody>
                          {listProduct.map((product, index) => (
                            <TableRow key={product.id}>
                              ...
                              <TableCell>
                                <Button className='bg-blue-600 text-white hover:bg-gray-300 hover:text-blue-600' color="primary" onClick={() => handleAddProduct(product)}>
                                  Chọn
                                </Button>
                              </TableCell>
                            </TableRow>
                    ...
                    <TableContainer>
                      ...
                      <Button className="bg-blue-600 text-white hover:bg-gray-300 hover:text-blue-600" onClick={() => handleAddImei(idBillDetail)}>
                        Chọn
                      </Button>
                    </TableContainer>
                  )}
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex justify-between pb-2 items-center">
                        ...
                        <div className="flex gap-x-2">
                          <Button variant="outline" value={1} className="border border-gray-500 rounded-lg hover:border-yellow-700 hover:text-yellow-700 px-3 text-2xs">
                            Tiền mặt
                          </Button>
                          <Button variant="outline" value={2} className="border border-gray-500 rounded-lg hover:border-red-600 hover:text-red-600 px-3 text-2xs">
                            Chuyển khoản
                          </Button>
                        </div>
                      </div>
              ...
              <div className="space-y-1" >
                <div className="bg-white p-6 rounded-lg shadow">
                  <div className="space-y-4">
                    ...
                    <div className="flex gap-x-2 justify-between border-b pb-2 pl-[25px]">
                      <Button variant="outline" value={1} className="border border-emerald-500 text-emerald-600 rounded-lg hover:border-yellow-700 hover:text-yellow-700 px-3 text-2xs">
                        Tiền mặt
                      </Button>
                      {/* Mã qr để chuyển khoản */}
                      <Dialog>
                        <DialogTrigger asChild>
                          <Button variant="outline" value={2} className="border border-blue-500 text-blue-600 rounded-lg hover:border-red-600 hover:text-red-600 px-3 text-2xs">
                            Chuyển khoản
                          </Button>
                        </DialogTrigger>
                        <DialogContent className="sm:max-w-[500px]">
                          ...
                          <Button variant="outline" className='bg-blue-600 text-white w-[100px] h-[40px] ml-[340px] hover:bg-sky-600 hover:text-white '>Xác nhận</Button>
                        </DialogContent>
                      </Dialog>
                    ...
                    <div className="flex justify-between border-b pb-2">
                      ...
                      <p className="font-semibold text-green-600">
                        <Input type="number" className='w-[150px]' placeholder="Nhập số tiền" value={customerPayment}
                          onChange={(e) => setCustomerPayment(Number(e.target.value))} /></p>
                    </div>
